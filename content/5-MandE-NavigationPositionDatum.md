...
# 5 Methods and Examples: Navigation, Position Fixing and Datum
...
For more information on Co-ordinate Reference Systems (CRS), please see 'Projections and co-ordinate systems' in the ADS [Good Practice Guide for GIS](https://doi.org/10.5284/vk98-3372).

```{figure} ../images/figure02.png
:alt: Navigation files created by Geosuite software

__Figure 2:__ Navigation files created by Geosuite software – Log (left), layback calculator (above right), and raw navigation files generated by the Trimble DGPS 12 channel receiver (below right). © IMARDIS Bangor University
```

## 5.2 Diver Tracking Systems
