...
# 6 Methods and Examples: Marine Survey Techniques - Sea Surface to the Seabed
...
## 6.1 Imagery - Digital Photographs and Video
...
The Stirling Castle was a 70-gun 3rd-rate ship-of-the-line, built in Deptford in 1679, and lost on the Goodwin Sands during the Great Storm of 1703. Numerous individuals, groups, Trusts and organisations have been involved in investigating this Designated Historic Shipwreck since its first discovery in 1979. Work on the archive generated between 1979-2009 has led to the production of a monograph, and access to the archive database and artefact images. The collection contains metadata describing the database and its structure, a database entity relationship diagram, plus 472 object images (a small chamber pot is shown image ref 361c.jpg) and is available from the ADS [@maritime2019].
````

````{admonition}  Case Study: Mystery Wreck Project (Flower of Ugie), Hampshire and Wight Trust for Maritime Archaeology, 2012
...
````{admonition} Case Study: Swan, Duart Point, Dr Colin Martin and Paul Martin
...
````{admonition} Case Study: HMS Colossus and the Wheel Wreck, CISMAS
...
````{admonition} Case Study: ‘The Diamond, Designated Historic Wreck Site Assessment, Wessex Archaeology and Cotswold Archaeology
...
__Figure 5:__ Output of data from Reson 7125 dual frequency (200 kHz and 400 kHz) SeaBat Multi-beam system for HMSM H5 in Cardigan Bay saved to .csv © IMARDIS Bangor University
```

````{admonition} Case Study: U-Boat Project 1914-18
...
````{admonition} Case Study: HM submarine A1, Designated Historic Wreck Site Assessment, Wessex Archaeology 
...
The reports of the survey are archived with the Archaeology Data Service [@wessex2012contract], whilst the geophysical survey data is archived through the MEDIN Data Archive Centres (British Geological Survey and United Kingdom Hydrographic Office).
````

## 6.8 Oceanographic Data Loggers
...
__Figure 6:__ Data acquired from Seabird SBE 911plus CTD with SBE32 water sampler deployed using a hydrographic winch aboard the Research Vessel Prince Madog in the vicinity to the wreck of the Apapa off North Anglesey (.hex file). The instrument recorded pressure, temperature, electrical conductivity, salinity, density, and sound velocity. The data is presented as exported tab-delimited ASCII and archived at [IMARDIS](http://portal.imardis.org/metadata/imardis:metadata:75f17942-827e-4ac9-a348-dc7358bfd1e9/downloads). A multi-beam image of the wreck is also shown.
```

```{figure} ../images/figure07.png
:alt: figure07

__Figure 7:__ Data structure of SEACAMS wave buoy deployed in Dales Roads from 2 December 2019 to 23 September 2021 downloaded as .xls file and processed in MS Excel to create a plot of annual sea temperatures © Bangor University. 
```